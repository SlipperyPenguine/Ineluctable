  ...
  <div class="col-md-12">
    <div class="ibox">
      <div class="ibox-heading">
        <h3 class="ibox-title">Industry Jobs</h3>
      </div>
                ...
                <tbody>
                  ...
                  @foreach ($current_jobs as $job)
                    ...
                    <tr>
                      ...
                      <td>
                        <img alt="image" height="32" class="img-circle" src="https://image.eveonline.com/Character/{{$job->installerID}}_32.jpg" />
                        {{ $job->installerName }}
                      </td>
                      <td>{{ $job->runs }}</td>
                      <td>
                        <img alt="image" height="32" class="img-circle" src="https://image.eveonline.com/Type/{{$job->blueprintTypeID}}_32.png" />
                        {{ $job->blueprintTypeName }}
                      </td>
                      <td>
                        <img alt="image" height="32" class="img-circle" src="https://image.eveonline.com/Type/{{$job->productTypeID}}_32.png" />
                        {{ $job->productTypeName }}
                      </td>
                      <td>{{ $job->location }}</td>
                    </tr>
                ...
                <tbody>
                  ...
                  @foreach ($finished_jobs as $job)
                    ...
                    <tr>
                      ...
                      <td>
                        <img alt="image" height="24" class="img-circle" src="https://image.eveonline.com/Character/{{$job->installerID}}_32.jpg" />
                        {{ $job->installerName }}
                      </td>
                      <td>{{ $job->runs }}</td>
                      <td>
                        <img alt="image" height="24" class="img-rounded" src="https://image.eveonline.com/Type/{{$job->blueprintTypeID}}_32.png" />
                        {{ $job->blueprintTypeName }}
                      </td>
                      <td>
                        <img alt="image" height="24" class="img-rounded" src="https://image.eveonline.com/Type/{{$job->productTypeID}}_32.png" />
                        {{ $job->productTypeName }}
                      </td>
                      <td>{{ $job->location }}</td>
                    </tr>
