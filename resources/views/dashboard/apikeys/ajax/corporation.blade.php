...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="callout callout-info">
            ...
            <form action="{{ URL::asset('dashboard/apikeys') }}" method="POST">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="keyID" value="{{ $keyID }}">
                <input type="hidden" name="vCode" value="{{ $vCode }}">
                <input type="submit" value="Add This Key" class="btn btn-primary">
            </form>
...
<div class="row">
    <div class="col-md-6">
        ...
        @foreach ($key_info->key->characters as $character)
            ...
            <div class="row">
                <div class="col-md-2">
                    <img alt="image" class="img-circle" src="https://imageserver.eveonline.com/Character/{{$character->characterID}}_64.jpg" />
                </div>
                <div class="col-md-6">
                    <blockquote>
