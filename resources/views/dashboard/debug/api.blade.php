...
@section('heading')API Check @endsection
@section('breadcrumbs')
  <li>
            ...
            <label class="select">
              ...
              <select name="characters" id="characters">
                @foreach($characterlist as $character)
                    <option value="{{$character->keyID}},{{$character->key->vCode}},{{$character->characterID}}">{{$character->characterName}}</option>
                @endforeach
              </select>
...
@section('scripts')
  ...
  $('#api').on('change', function() {
    ...
    $('#characters').on('change', function() {
      ...
      var detsarray = new Array();
      detsarray = $("#characters").val().split(",");

      var key = detsarray[0];
      var vcode = detsarray[1];
      var charid = detsarray[2];
