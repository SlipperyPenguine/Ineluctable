...
class EveApiCalllistTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        EveApiCalllist::create(array('type' => 'Account', 'name' => 'AccountStatus', 'accessMask' => 33554432, 'description' => 'EVE player account status.'));
        EveApiCalllist::create(array('type' => 'eve', 'name' => 'CharacterInfo', 'accessMask' => 16777216, 'description' => 'Sensitive Character Information, exposes account balance and last known location on top of the other Character Information call.'));
        EveApiCalllist::create(array('type' => 'eve', 'name' => 'CharacterInfo', 'accessMask' => 8388608, 'description' => 'Character information, exposes skill points and current ship information on top of \'Show Info\' information.'));
        ...
        EveApiCalllist::create(array('type' => 'Corporation', 'name' => 'MemberTracking', 'accessMask' => 33554432, 'description' => 'Extensive Member information. Time of last logoff, last known location and ship.'));
        ...
        //new added by JB
        EveApiCalllist::create(array('type' => 'Character', 'name' => 'Bookmarks', 'accessMask' => 268435456, 'description' => 'List of all personal bookmarks.'));
        EveApiCalllist::create(array('type' => 'Character', 'name' => 'ChatChannels', 'accessMask' => 536870912, 'description' => 'List of player chat channels you have created or are an operator of.'));

        EveApiCalllist::create(array('type' => 'eve', 'name' => 'AllianceList', 'accessMask' => 2, 'description' => ''));
        EveApiCalllist::create(array('type' => 'eve', 'name' => 'CharacterAffiliation', 'accessMask' => 2, 'description' => ''));
        EveApiCalllist::create(array('type' => 'eve', 'name' => 'ConquerableStationList', 'accessMask' => 2, 'description' => ''));
        EveApiCalllist::create(array('type' => 'eve', 'name' => 'SkillTree', 'accessMask' => 2, 'description' => ''));

        EveApiCalllist::create(array('type' => 'Map', 'name' => 'Kills', 'accessMask' => 2, 'description' => ''));
        EveApiCalllist::create(array('type' => 'Map', 'name' => 'Jumps', 'accessMask' => 2, 'description' => ''));
        EveApiCalllist::create(array('type' => 'Map', 'name' => 'Sovereignty', 'accessMask' => 2, 'description' => ''));
