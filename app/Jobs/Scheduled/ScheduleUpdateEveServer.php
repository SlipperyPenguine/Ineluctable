...
use ineluctable\Jobs\UpdateEveServerStatus;
use Log;

class ScheduleUpdateEveServer extends Job implements SelfHandling, ShouldQueue
{
    ...
    public function handle()
    {
        ...
        event(new ScheduleUpdateEveServerCompleted($this->job->getJobId() , $this->job->getQueue() , static::class, $this->starttime, Carbon::Now(), $params));
