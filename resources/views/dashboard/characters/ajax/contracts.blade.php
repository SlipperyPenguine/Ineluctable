  ...
  <div class="col-md-12">
    <div class="ibox">
      <div class="ibox-heading">
        <h3 class="ibox-title">Contract List ({{ count($contracts_courier) +  count($contracts_other)}})</h3>
      </div><!-- /.box-header -->
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="ibox box-solid box-primary">
              <div class="ibox-heading">
                <h3 class="ibox-title">Item Exchange &amp; Auction ({{ count($contracts_other) }})</h3>
              </div>
              <div class="ibox-content no-padding">
                <div class="row">
                  <div class="col-md-12">
                        ...
                        <tbody style="border-top:0px solid #FFF">
                          <tr class="item-container">
                            <td style="width: 200px">
                              {!!   ineluctable\Services\Helpers\Img::html($contract->issuerID, 16) !!}
                              <span rel="id-to-name">{{ $contract->issuerID }}</span>
                            </td>
                            <td style="width: 200px">
                              @if ($contract->assigneeID <> 0)
                                {!!  ineluctable\Services\Helpers\Img::html($contract->assigneeID, 16) !!}
                        ...
                        <ul class="list-unstyled">
                          ...
                          @if(isset($contract->dateCompleted))
                            <li>
                              ...
                              by
                                {!! ineluctable\Services\Helpers\Img::html($contract->acceptorID, 16) !!}
                              <b><span rel="id-to-name">{{ $contract->acceptorID }}</span></b>
                            </li>
                          @endif
                          <li>
                            <i class="fa fa-money"></i>
                            Buyer will get <b><span class="text-green">{{ number_format($contract->reward, 2,$decimal_seperator,$thousand_seperator) }}</span></b> ISK
                          </li>
                          <li>
                            <i class="fa fa-money"></i>
                            Buyer will pay <b><span class="text-red">{{ number_format($contract->price, 2, $decimal_seperator,$thousand_seperator) }}</span></b> ISK
                          </li>
                          ...
                          @if($contract->type == 'Auction')
                            <li>
                              <i class="fa fa-money"></i>
                              <b>{{ number_format($contract->buyout, 2, $decimal_seperator,$thousand_seperator) }}</b> ISK buyout
                            </li>
                          @endif

                          {{-- Check if contract has contents --}}
                          @if(isset($contract->items) && count($contract->items) > 0)
                            ...
                            <li>
                              <div class="col-md-6">
                                <ul>
                                  ...
                                  @foreach($contract->items as $content)

                                    <li style="list-style:none;">
                                      {{-- Check if it's a item request or not --}}
                                      @if($content->included == 1)
                                          {!! ineluctable\Services\Helpers\Img::type($content->typeID, 16, true) !!}
                                        <span>{{  number_format($content->quantity, 0, $decimal_seperator,$thousand_seperator) }} x {{ $content->type->typeName }}</span>
                                      @endif
                                    </li>
          ...
          <div class="col-md-6">
            <div class="ibox box-solid box-primary">
              <div class="ibox-heading">
                <h3 class="ibox-title">Courier ({{ count($contracts_courier) }})</h3>
              </div>
              <div class="ibox-content no-padding">
                <div class="row">
                  <div class="col-md-12">
                      ...
                      <div class="col-md-12 tbodycontent" style="display: none;">
                        <ul class="list-unstyled">
                          <li>
                            ...
                            <span>
                             ({{ number_format($contract->volume, 2,$decimal_seperator,$thousand_seperator) }} m<sup>3</sup>)
                            </span>
                          </li>
                          @if(isset($contract->title) && strlen($contract->title) > 0)
                            <li>
                          ...
                          @if(isset($contract->dateAccepted))
                            <li>
                              ...
                              by
                                {!! ineluctable\Services\Helpers\Img::character($contract->acceptorID, 16) !!}
                              <b><span rel="id-to-name">{{ $contract->acceptorID }}</span></b>
                            </li>
                          @endif
