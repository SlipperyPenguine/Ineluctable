...
use ineluctable\EveApi\Eve\ConquerableStationList;


class UpdateEveConquerableStationList extends Job implements SelfHandling
{
    ...
    {
        Log::info('Started job UpdateEveRefTypes', array('src' => __CLASS__));

        try
        {
            ConquerableStationList::Update();
