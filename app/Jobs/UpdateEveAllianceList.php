...
use ineluctable\EveApi\Eve\AllianceList;


class UpdateEveAllianceList extends Job implements SelfHandling
{
    ...
    {
        Log::info('Started job UpdateEveAllianceList', array('src' => __CLASS__));
